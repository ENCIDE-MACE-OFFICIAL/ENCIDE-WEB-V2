      ...
      <div className="container mx-auto px-4 lg:px-16">
        ...
        >
          <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-4">
            Let's{" "}
            <span className="bg-red-400 bg-clip-text text-[#cd3737]">
              Connect
            </span>
          </h2>
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-br from-red-600 to-red-700 text-white hover:bg-red-700 hover:transition hover:duration-250 h-12 rounded-lg px-8 active:scale-[0.98] duration-200"
              >
                {isSubmitting ? (
                  <>
