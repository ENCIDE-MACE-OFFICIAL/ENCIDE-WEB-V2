    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-12 relative z-10">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll("left")}
            className={`absolute left-0 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full bg-red-600 text-white hover:bg-red-700 transition-all duration-300 shadow-lg -ml-6 ${
          ...
          <button
            ...
            className={`absolute right-0 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full bg-red-600 text-white hover:bg-red-700 transition-all duration-300 shadow-lg -mr-6 ${
